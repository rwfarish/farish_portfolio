    ...
    <div className={styles.intro}>
      <div className={styles.shortOne}>
        <img
          ...
          src="/assets/images/illustrations/Headshot.jpeg"
          alt="headshot"
        ></img>
      ...
      <div className={styles.longOne}>
        <p>
          I am a full stack web developer. I’m experienced in{' '}
          <strong>HTML5</strong>, <strong>CSS3</strong> and{' '}
          <strong>JavaScript</strong> including modern libraries such as{' '}
          <strong>React</strong> and frameworks such as <strong>Next.js</strong>
          . In back end technologies I am experienced in{' '}
        ...
        <p>
          ...
          <a href="https://harborec.com" target="_blank" rel="noreferrer">
        ...
        <p>
          ...
          high functioning, clean, and aesthetically pleasing websites and
          applications.
        </p>
      </div>
    </div>
